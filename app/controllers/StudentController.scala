...
class StudentController @Inject()(
  ...
  def searchStudentByName(name: String): Action[AnyContent] = Action.async { implicit request: Request[AnyContent] =>
  ...
  def studentWithUniversityName(): Action[AnyContent] = Action.async { implicit request: Request[AnyContent] => {
